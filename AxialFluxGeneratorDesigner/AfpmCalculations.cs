...
namespace AxialFluxGeneratorDesigner
{
    ...
    public class Afpm
    {
        ...
        private static double CalculateTorque(double power, int rpm)
        {
        ...
        private static int CalculateGridRpm(double phaseVoltageMin, double phaseVoltageMax, int nominalRpm)
        {
        ...
        private static double CalculateBatteryVoltage(double rpmMin, double rpmMax, double minimalPhaseVoltage)
        {
        ...
        private static double CalculateCoilAngle(int coilCount)
        {
            if (coilCount == 0)
            {
                return 0;
        ...
        private static double CalculateCoilInductance(int windingCount, double coilDiameter, double coilThickness)
        {
        ...
        public static double CalculateCoilResistance(double coilWireLength, double wireDiameter)
        {
            const double copperResistivity = 0.0000000168;
            var wireRadius = wireDiameter/2;
        ...
        public static Tuple<double, double, double, double> CoilInnerDimensions(double coilLegWidth, int coilCount,
        ...
        public static Tuple<double, double, double, double> CoilOuterDimensions(double coilLegWidth, int coilCount,
            double coilGap, double betweenCoilGap, double magnetHeight)
        {
            //Debug.WriteLine("----------Inner Coil dimensions----------");
        ...
        private static double CalculateCoilArcLength(double angle, double radius)
        {
        ...
        private static double CalculateCoilLineLength(double angle, double radius)
        {
        ...
        private static double CalculateCircleTangent(double radius)
        {
        ...
        public static double CalculateCalculateGeneratorOuterRadius(double generatorInnerRadius, double magnetLength)
        {
        ...
        public static double CalculateCoilOuterCornerRadius(double coilInnerRadius, double coilLegWidth)
        {
        ...
        public static double CalculateOuterCoilTopVertexLength(double outerNGonRadius, int verticesCount)
        {
        ...
        public static double CalculateOuterCoilBottomVertexLength(double coilLegWidth)
        {
        ...
        /// <returns></returns>
        public static double CalculateInnerCoilBottomVertexLength(double coilLegWidth, double coilAngle)
        {
        ...
        /// <param name="coilAngle"></param>
        /// <returns></returns>
        public static double CalculateInnerTopVertexLength(double coilLegWidth, double magnetHeight, double coilAngle)
        {
        ...
        public static double CalculateNGonOuterRadius(double vertexLenght, double verticesCount)
        {
        ...
        /// <param name="verticesCount">The amount of vertices</param>
        /// <returns></returns>
        public static double CalculateNGonInnerRadius(double vertexLenght, double verticesCount)
        {
        ...
        public void UpdateCalculations(bool debug)
        {
            ...
            UpdateStatorCalculations();
            UpdateRotorCalculations();
        }

        /// <summary>
        ///     This method updates the calculations for the ront end of the generator. The device that is resposible for
        ///     generation of RPM.
        /// </summary>
        private void UpdateFrontEndCalculations()
        {
        ...
        {
            //TODO remve 286 V??
            MaxPhaseCurrent = CalculateMaximumPhaseCurrent(GeneratorPower, 286, GeneratorEfficiency);
        ...
        public void UpdateRotorCalculations()
        {
            ...
            //TODO: Make separate variable so no stator variables are used in this method
            var coilOuterDimension = CoilOuterDimensions(CoilLegWidth, CoilCount, 10, 1, MagnetLength);
