...
namespace AxialFluxGeneratorDesigner
{
    ...
    public partial class FormAfpmDesigner : Form
    {
        ...
        /// </summary>
        HelixViewport3D GeneratorView = new HelixViewport3D();
        ...
        {
            elementHost1.Child = GeneratorView;
            ...
            lblMagnetRemanenceValue.Text = _generator.MagnetProperties[cmbMagnetGrade.SelectedIndex].Item2.ToString(CultureInfo.InvariantCulture);
            lblCoerciveFieldStrengthValue.Text = _generator.MagnetProperties[cmbMagnetGrade.SelectedIndex].Item3.ToString(CultureInfo.InvariantCulture);
        ...
        private void UpdateGuiElements()
        {
            ...
            lblStatorThicknessValue.Text = Math.Round(_generator.CoilThickness, 2).ToString(CultureInfo.InvariantCulture);
            lblCoilTurnsValue.Text = _generator.CoilTurns.ToString();
            lblMagnetFluxDensityValue.Text = Math.Round(_generator.MagnetFluxDensity, 2).ToString(CultureInfo.InvariantCulture);
            lblMagnetFluxValue.Text = Math.Round(_generator.MagnetPoleFlux * 1000, 2).ToString(CultureInfo.InvariantCulture);
            lblMaxCoilCurrentDensityValue.Text = Math.Round(_generator.MaxCurrentDensity, 2).ToString(CultureInfo.InvariantCulture);
            lblCoilWireDiameterValue.Text = Math.Round(_generator.CoilWireDiameter, 2).ToString(CultureInfo.InvariantCulture);
            lblRotorOuterRadiusValue.Text = Math.Round(_generator.RotorOuterRadius, 2).ToString(CultureInfo.InvariantCulture);
            lblRotorInnerRadiusValue.Text = Math.Round(_generator.RotorInnerRadius, 2).ToString(CultureInfo.InvariantCulture);
            lblRotorInnerouterRadiusRatioValue.Text = Math.Round(_generator.RotorInnerOuterRadiusRatio, 2).ToString(CultureInfo.InvariantCulture);
            lblRotorThicknessValue.Text = Math.Round(_generator.RotorThickness, 2).ToString(CultureInfo.InvariantCulture);
            lblPhaseVoltageMinValue.Text = Math.Round(_generator.PhaseVoltageMin, 2).ToString(CultureInfo.InvariantCulture);
            lblPhaseVoltageMaxValue.Text = Math.Round(_generator.PhaseVoltageMax, 2).ToString(CultureInfo.InvariantCulture);
            lblMagnetCountValue.Text = _generator.MagnetCount.ToString();
            lblCoilCountValue.Text = _generator.CoilCount.ToString();
            lblMagnetDistanceValue.Text = Math.Round(_generator.MagnetDistance, 2).ToString(CultureInfo.InvariantCulture);
            lblMagnetArcPolePitchValue.Text = Math.Round(_generator.MagnetPoleArcPitch, 2).ToString(CultureInfo.InvariantCulture);
            lblMaxPhaseCurrentValue.Text = Math.Round(_generator.MaxPhaseCurrent, 2).ToString(CultureInfo.InvariantCulture);
            numWindSpeedCutIn.Value = (decimal)Math.Round(_generator.TurbineWindspeedMin, 2);
            lblTurbineRotorRadiusValue.Text = Math.Round(_generator.TurbineRotorRadius, 2).ToString(CultureInfo.InvariantCulture);
            lblCoilResistanceValue.Text = Math.Round(_generator.CoilResistance, 2).ToString(CultureInfo.InvariantCulture);
            lblCoilInductanceValue.Text = Math.Round(_generator.CoilInductance, 2).ToString(CultureInfo.InvariantCulture);
            lblCoilWireLengthValue.Text = Math.Round(_generator.CoilWireLength, 2).ToString(CultureInfo.InvariantCulture);
            lblGeneratorPhaseCountValue.Text = _generator.PhaseCount.ToString();
            lblPhaseWireVoltageDropValue.Text = Math.Round(_generator.PhaseWireVoltageDrop, 2).ToString(CultureInfo.InvariantCulture);
            lblPhaseWireResistanceValue.Text = Math.Round(_generator.PhaseWireResistance, 2).ToString(CultureInfo.InvariantCulture);
            lblRectifierWireVoltageDropValue.Text = Math.Round(_generator.RectifierWireVoltageDrop, 2).ToString(CultureInfo.InvariantCulture);
            lblRectifierWireResistanceValue.Text = Math.Round(_generator.RectifierWireResistance, 2).ToString(CultureInfo.InvariantCulture);
            lblTurbineMaximalTorqueValue.Text = Math.Round(_generator.FrontEndTorque, 2).ToString(CultureInfo.InvariantCulture);
            numRpmMin.Value = _generator.FrontEndRpmMin;
            numRpmMax.Value = _generator.FrontEndRpmMax;
        }
        ...
        public void FillIterationTable()
        {
            ...
            {
                _generator.DcVoltageMin = IterableCalculate(numIterateDcVoltageBatteryMinLower, numIterateDcVoltageBatteryMinUpper, i);
                _generator.DcVoltageMax = IterableCalculate(numIterateDcVoltageBatteryMaxLower, numIterateDcVoltageBatteryMaxUpper, i);
                ...
                _generator.TurbineSpeedTipRatioMax = IterableCalculate(numSpeedTipRatioMaxLower, numSpeedTipRatioMaxUpper, i);
                _generator.TurbineWindspeedMin = IterableCalculate(numWindSpeedMinLower, numWindSpeedMinUpper, i);
                _generator.TurbineSpeedTipRatioMin = IterableCalculate(numSpeedTipRatioMinLower, numSpeedTipRatioMinUpper, i);
                ...
                _generator.RectifierWireLength = IterableCalculate(numRectifierWireLengthLower, numRectifierWireLengthUpper, i);
                _generator.RectifierWireDiameter = IterableCalculate(numRectifierWireDiameterLower, numRectifierWireDiameterUpper, i);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (Math.Abs(xValue.Min() - xValue.Max()) < 0.0000001 || Math.Abs(yValue.Min() - yValue.Max()) < 0.0000001)
                    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    for (int i = 1; i < _tableGeneratorSummary.Columns.Count; i++)
                    {
                        xValue.Add(Convert.ToDouble(_tableGeneratorSummary.Rows[cmbChart2xAxis.SelectedIndex][i].ToString()));
                        yValue.Add(Convert.ToDouble(_tableGeneratorSummary.Rows[cmbChart2yAxis.SelectedIndex][i].ToString()));
                    }

                    if (Math.Abs(xValue.Min() - xValue.Max()) < 0.000000001 || Math.Abs(yValue.Min() - yValue.Max()) < 0.000000001)
                    {
                        MessageBox.Show("The selected data cannot be charted!");
                    }
                    else
                    {
                        ...
                        chartData2.ChartAreas[0].AxisX.Title = _tableGeneratorSummary.Rows[cmbChart2xAxis.SelectedIndex][0].ToString();
                        chartData2.ChartAreas[0].AxisY.Title = _tableGeneratorSummary.Rows[cmbChart2yAxis.SelectedIndex][0].ToString();
        ...
        private void tabPage4_Enter(object sender, EventArgs e)
        {
            ...
            var start = new ProcessStartInfo
            {
                ...
                Arguments = string.Format(@"Python\3dGenerator.py {0} {1} {2} {3} {4} {5} {6} {7} {8}", _generator.MagnetLength, _generator.MagnetWidth, _generator.CoilCount, _generator.CoilLegWidth, 1,1, _generator.CoilThickness, 9,4),
                CreateNoWindow = true,
            ...
            GeneratorView.Children.Add(lights);
            GeneratorView.Children.Add(device3D);
            GeneratorView.ZoomSensitivity = 3;
        }
        ...
        private Model3D Display3d(string model)
        {
            ...
            try
            {
                ...
                GeneratorView.RotateGesture = new MouseGesture(MouseAction.LeftClick);
