...
namespace AxialFluxGeneratorDesigner.Gui
{
    ...
    public class Iterator
    {
        ...
        //    _form.numIterateDcVoltageBatteryMinLower.Value = (decimal) _generator.DcInverterVoltageMin;
        //    _form.numIterateDcVoltageBatteryMinUpper.Value = (decimal) _generator.DcInverterVoltageMin;
        //    _form.numIterateDcVoltageBatteryMaxLower.Value = (decimal) _generator.DcInverterVoltageMax;
        //    _form.numIterateDcVoltageBatteryMaxUpper.Value = (decimal) _generator.DcInverterVoltageMax;
        //    _form.numShaftPowerLower.Value = (decimal) _generator.GeneratorPower.Value;
        //    _form.numShaftPowerUpper.Value = (decimal) _generator.GeneratorPower.Value;
        ...
        //    {
        //        _generator.DcInverterVoltageMin = IterableCalculate(_form.numIterateDcVoltageBatteryMinLower,
        //            _form.numIterateDcVoltageBatteryMinUpper, i);
        //        _generator.DcInverterVoltageMax = IterableCalculate(_form.numIterateDcVoltageBatteryMaxLower,
        ...
        //        _iteratorSummary.Rows[0][i + 1] = _generator.DcInverterVoltageMin;
        //        _iteratorSummary.Rows[1][i + 1] = _generator.DcInverterVoltageMax;
