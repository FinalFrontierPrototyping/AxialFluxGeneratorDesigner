...
#This file is used to generate an obj file using FreeCAD. The generated file if imported into C# using the helix toolkit. Also a *.FCStd is generated so the model can be edited from FreeCAD.
...
class AFPM:
    def __init__(self, magnet_length, magnet_height, coil_count, leg_width, between_coil, wire_diameter, coil_thickness,
        ...
        import importOBJ
        importOBJ.export(__objs__,path + u"\\AFPM.stl")
        importOBJ.export(__objs__,path + u"\\AFPM.ply")
